...
{9,03,06,06,cir,0xff},
{06,10,18,30,pos,0x80},
{06,10,18,30,pos,0x08},
{06,10,18,30,pos,0x01},
...
vector_font One={
{07,10,00,30,pos,0x80},
{07,10,00,30,pos,0x10},
{07,10,00,30,pos,0x08},
{07,10,00,30,pos,0x01},
{05,18,06,06,pos,0x80},
{05,18,06,06,pos,0x10},
{05,18,06,06,pos,0x08},
{05,18,06,06,pos,0x01},
{.flag=0x8c},
...
{06,00,18,00,pos,0x80},
{06,00,18,00,pos,0x10},
{06,00,18,00,pos,0x08},
{06,00,18,00,pos,0x01},
{.flag=0x8c},

};
vector_font Three={
{06,06,12,12,cir,0xf0},
{06,06,12,12,cir,0x01},
{06,20,10,16,cir,0xc0},
{06,20,15,00,pos,0x80},
{06,20,15,00,pos,0x10},
{06,20,15,00,pos,0x08},
{06,20,15,00,pos,0x01},
{.flag=0x8c},
...
{8,10,00,30,pos,0x08},
{8,10,00,30,pos,0x01},
{06,06,18,00,pos,0x80},
{06,06,18,00,pos,0x10},
{06,06,18,00,pos,0x08},
{06,06,18,00,pos,0x01},
{04,13,12,22,pos,0x80},
{04,13,12,22,pos,0x10},
{04,13,12,22,pos,0x08},
{04,13,12,22,pos,0x01},
{.flag=0x8c},

};
vector_font Five={
{06,06,12,12,cir,0xf8},
{06,06,12,12,cir,0x01},
{03,15,03,15,pos,0x80},
{03,15,03,15,pos,0x10},
{03,15,03,15,pos,0x08},
{03,15,03,15,pos,0x01},
{8,20,12,00,pos,0x80},
{8,20,12,00,pos,0x10},
{8,20,12,00,pos,0x08},
{8,20,12,00,pos,0x01},
...
vector_font Seven={
//{06,10,18,30,pos,0x80},
//{06,10,18,30,pos,0x10},
//{06,10,18,30,pos,0x08},
//{06,10,18,30,pos,0x01},
//{06,20,18,00,pos,0x80},
//{06,20,18,00,pos,0x10},
//{06,20,18,00,pos,0x08},
//{06,20,18,00,pos,0x01},
{06,10,18,30,pos,0x99},
...
vector_font BigC={
{07,10,14,20,cir,0x80},
{07,10,14,20,cir,0x10},
{07,10,14,20,cir,0x0f},
{.flag=0x8c},
...
{06,06,12,12,cir,0xc0},
{06,06,12,12,cir,0x03},
{.flag=0x8c},
...
vector_font BigP={
{00,10,00,30,pos,0x80},
{00,10,00,30,pos,0x10},
{00,10,00,30,pos,0x08},
{00,10,00,30,pos,0x01},
{04,10,12,00,pos,0x80},
{04,10,12,00,pos,0x10},
{04,10,12,00,pos,0x08},
{04,10,12,00,pos,0x01},
{04,20,12,00,pos,0x80},
{04,20,12,00,pos,0x10},
{04,20,12,00,pos,0x08},
{04,20,12,00,pos,0x01},
{8,15,10,10,cir,0xf0},
{.flag=0x8c},
...
vector_font BigS={
{06,05,12,10,cir,0xf0},
{06,05,12,10,cir,0x03},
{06,15,12,10,cir,0x30},
{06,15,12,10,cir,0x0f},
{.flag=0x8c},
...
vector_font SmallD={
{05,06,10,12,cir,0xff},
{10,10,00,30,pos,0x80},
{10,10,00,30,pos,0x10},
{10,10,00,30,pos,0x08},
{10,10,00,30,pos,0x01},
{.flag=0x8a},
...
vector_font SmallL={
{01,10,00,30,pos,0x80},
{01,10,00,30,pos,0x10},
{01,10,00,30,pos,0x08},
{01,10,00,30,pos,0x01},
{.flag=0x82},
